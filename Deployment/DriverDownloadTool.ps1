<#
    ...
    .DESCRIPTION
		...
		Version 2.6 Minor UI changes and MDT variable bug fix when selecting download only.
					Import list models will now select all models unless individual models are		
					selected when initiating the download process.
#>
...
"@ -IgnoreWarnings | Out-Null
	...
	$StartDownloadButton_Click = {
		...
		If ($ValidationErrors -eq 0)
		{
			...
			foreach ($Model in $ImportModels)
			{
				...
				If ($ImportInto -like "*SCCM*") { $DriverPackageRoot = ($PackagePath.Trimend("\") + "\$Make\") }
									...
									if ($ImportInto -like "*Driver*")
									{
										...
										if ((Get-CMDriverPackage -Name $CMDriverPackage | Where-Object { $_.Version -eq $DriverRevision }) -eq $null)
										{
											...
											if ($DriverINFFiles.Count -gt $null)
											{
												...
												<# 
												$ProgressListBox.Items.Add("$($Product): Adding Drivers To $DriverCategory Driver Package")
												UpdateLogWindow
												Get-CMDriver | Where-Object {$_.LocalizedCategoryInstanceNames -eq $DriverCategory}
												#>
	...
	$MainForm.Text = 'SCConfgMgr.com - Driver Download Automation Tool v2.6'
...
'
	...
	$labelPleaseSelectManufact.Font = 'Montserrat, 7.79999971pt, style=Bold'
	$labelPleaseSelectManufact.Location = '25, 22'
	$labelPleaseSelectManufact.Name = 'labelPleaseSelectManufact'
	$labelPleaseSelectManufact.Size = '218, 16'
	...
	$FullModelListBox.ForeColor = '162, 1, 0'
	...
	$textbox1.Font = 'Montserrat, 7.79999971pt'
...
'
	...
	$labelPleaseNote.Font = 'Montserrat, 7.79999971pt, style=Bold'
	$labelPleaseNote.Location = '300, 27'
	$labelPleaseNote.Name = 'labelPleaseNote'
	$labelPleaseNote.Size = '103, 16'
	...
	$labelCautionYourTaskSeque.Font = 'Montserrat, 7.79999971pt, style=Bold'
	...
	$labelCautionYourTaskSeque.Size = '577, 16'
	...
	$label1.Font = 'Montserrat, 7.79999971pt'
	...
	#
	$DeployEverythingcomLink.ActiveLinkColor = '162, 1, 0'
	$DeployEverythingcomLink.Font = 'Montserrat, 9pt, style=Bold'
	$DeployEverythingcomLink.LinkColor = '162, 1, 0'
	$DeployEverythingcomLink.Location = '806, 625'
	$DeployEverythingcomLink.Margin = '4, 0, 4, 0'
	$DeployEverythingcomLink.Name = 'DeployEverythingcomLink'
	$DeployEverythingcomLink.Size = '162, 30'
	$DeployEverythingcomLink.TabIndex = 38
	$DeployEverythingcomLink.TabStop = $True
	$DeployEverythingcomLink.Text = 'SCConfgMgr.com'
	#
	# SCCMDellTabControl
	#
	...
	$labelPassword.Font = 'Montserrat, 7.79999971pt, style=Bold'
	$labelPassword.ForeColor = '162, 1, 0'
	$labelPassword.Location = '568, 41'
	$labelPassword.Margin = '4, 0, 4, 0'
	$labelPassword.Name = 'labelPassword'
	$labelPassword.Size = '80, 16'
	...
	$labelUsername.Font = 'Montserrat, 7.79999971pt, style=Bold'
	$labelUsername.ForeColor = '162, 1, 0'
	$labelUsername.Location = '564, 12'
	$labelUsername.Margin = '4, 0, 4, 0'
	$labelUsername.Name = 'labelUsername'
	$labelUsername.Size = '82, 16'
	...
	$labelProxyServer.Font = 'Montserrat, 7.79999971pt, style=Bold'
	$labelProxyServer.ForeColor = '162, 1, 0'
	$labelProxyServer.Location = '204, 25'
	$labelProxyServer.Margin = '4, 0, 4, 0'
	$labelProxyServer.Name = 'labelProxyServer'
	$labelProxyServer.Size = '100, 16'
...
')
	#endregion
	...
	$ProductListBox.ForeColor = '162, 1, 0'
